...
Purpose: (1) to gain an understanding of how everybody in the lab is going with their project, and (2) to determine if anybody requires individual meetings. Status meetings will be _only 30 minutes_ (approx 3 minutes each).

### On-demand individual meeting (&le; 30 minutes)
...
1. **Getting started** — defining research topic and objectives, background reading, finding your "unsolved problem", discovering code frameworks.
2. **The Work** — coding up a system, iterating on a design, running experiments.
3. **The Write-up** — expressing your process, analysing and discussing results, writing documentation and packaging code.
...
- End of week 8: Draft of report _System Design_ section
